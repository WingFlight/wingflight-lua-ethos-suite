...
source: app/pages/esc_forward_blheli_s.lua
---
...
*Configuration* → *Setup* → *ESC & Motors* → *ESC Prog.* → *BLHeli_S*
...
[Page implementation](../../../src/wfsuite/app/pages/esc_forward_blheli_s.lua). Menu conditions come from `app/tool.lua`.
