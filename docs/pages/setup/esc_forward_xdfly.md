...
source: app/pages/esc_forward_xdfly.lua
---
...
Requires a running background task and a flight controller connection. Lit only while the flight controller reports this ESC telemetry protocol (Protocol ID: 12).
...
[Page implementation](../../../src/wfsuite/app/pages/esc_forward_xdfly.lua). Menu conditions come from `app/tool.lua`.
