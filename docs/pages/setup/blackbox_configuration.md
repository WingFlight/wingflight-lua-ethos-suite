...
source: app/pages/blackbox_configuration.lua
---
...
*Configuration* → *Setup* → *Controls* → *Blackbox* → *Configuration*
...
[Page implementation](../../../src/wfsuite/app/pages/blackbox_configuration.lua). Menu conditions come from `app/tool.lua`.
