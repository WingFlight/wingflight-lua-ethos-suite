...
source: app/pages/esc_forward_omp.lua
---
...
Requires a running background task and a flight controller connection. Lit only while the flight controller reports this ESC telemetry protocol (Protocol ID: 6).
...
[Page implementation](../../../src/wfsuite/app/pages/esc_forward_omp.lua). Menu conditions come from `app/tool.lua`.
