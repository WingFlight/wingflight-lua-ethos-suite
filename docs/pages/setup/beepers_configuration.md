...
source: app/pages/beepers_configuration.lua
---
...
*Configuration* → *Setup* → *Controls* → *Beepers* → *Configuration*
...
[Page implementation](../../../src/wfsuite/app/pages/beepers_configuration.lua). Menu conditions come from `app/tool.lua`.
