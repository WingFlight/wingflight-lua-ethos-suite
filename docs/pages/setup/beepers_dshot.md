---
title: "ESC Beacon"
sidebar_label: "ESC Beacon"
sidebar_position: 20
documentation_status: draft
source: app/pages/beepers_dshot.lua
---
...
*Configuration* → *Setup* → *Controls* → *Beepers* → *ESC Beacon*
...
[Page implementation](../../../src/wfsuite/app/pages/beepers_dshot.lua). Menu conditions come from `app/tool.lua`.
