...
*Configuration* → *Flight Tuning* → *Advanced* → *Thrust Vector* → *Attitude / Heading Hold*
...
[Page implementation](../../../src/wfsuite/app/pages/thrust_vector_hold.lua). Menu conditions come from `app/tool.lua`.
