...
source: app/pages/thrust_vector_pids.lua
---
...
*Configuration* → *Flight Tuning* → *Advanced* → *Thrust Vector* → *PIDs*
...
[Page implementation](../../../src/wfsuite/app/pages/thrust_vector_pids.lua). Menu conditions come from `app/tool.lua`.
