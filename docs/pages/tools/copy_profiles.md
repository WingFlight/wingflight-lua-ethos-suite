...
source: app/pages/copy_profiles.lua
---
...
| --- | --- |
| Profile Type | TODO: explain behaviour, displayed units, range and conditions. |
| Source Profile | TODO: explain behaviour, displayed units, range and conditions. |
| Dest. Profile | TODO: explain behaviour, displayed units, range and conditions. |
...
[Page implementation](../../../src/wfsuite/app/pages/copy_profiles.lua). Menu conditions come from `app/tool.lua`.
