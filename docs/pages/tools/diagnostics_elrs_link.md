...
sidebar_label: "ELRS Telemetry"
sidebar_position: 20
documentation_status: draft
source: app/pages/diagnostics_elrs_link.lua
---
...
*System* → *Tools* → *Diagnostics* → *ELRS Telemetry*
...
[Page implementation](../../../src/wfsuite/app/pages/diagnostics_elrs_link.lua). Menu conditions come from `app/tool.lua`.
