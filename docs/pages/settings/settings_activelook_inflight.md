---
title: "Inflight"
sidebar_label: "Inflight"
sidebar_position: 30
documentation_status: draft
source: app/pages/settings_activelook_inflight.lua
---
...
*System* → *Settings* → *ActiveLook* → *Inflight*
...
[Page implementation](../../../src/wfsuite/app/pages/settings_activelook_inflight.lua). Menu conditions come from `app/tool.lua`.
