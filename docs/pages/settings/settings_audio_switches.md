...
source: app/pages/settings_audio_switches.lua
---
...
*System* → *Settings* → *Audio* → *Switches*
...
[Page implementation](../../../src/wfsuite/app/pages/settings_audio_switches.lua). Menu conditions come from `app/tool.lua`.
