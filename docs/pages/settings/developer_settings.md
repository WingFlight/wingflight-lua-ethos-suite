...
source: app/pages/developer_settings.lua
---
...
| --- | --- |
| Debug logs | TODO: explain behaviour, displayed units, range and conditions. |
| Log MSP data | TODO: explain behaviour, displayed units, range and conditions. |
| Memory logs | TODO: explain behaviour, displayed units, range and conditions. |
| Simulated API version | TODO: explain behaviour, displayed units, range and conditions. |
...
[Page implementation](../../../src/wfsuite/app/pages/developer_settings.lua). Menu conditions come from `app/tool.lua`.
