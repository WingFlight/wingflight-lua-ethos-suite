...
source: app/pages/settings_activelook_preflight.lua
---
...
*System* → *Settings* → *ActiveLook* → *Preflight*
...
[Page implementation](../../../src/wfsuite/app/pages/settings_activelook_preflight.lua). Menu conditions come from `app/tool.lua`.
