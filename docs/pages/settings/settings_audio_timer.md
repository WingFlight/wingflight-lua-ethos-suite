...
source: app/pages/settings_audio_timer.lua
---
...
| --- | --- |
| Timer audio | TODO: explain behaviour, displayed units, range and conditions. |
| Elapsed alert | TODO: explain behaviour, displayed units, range and conditions. |
...
[Page implementation](../../../src/wfsuite/app/pages/settings_audio_timer.lua). Menu conditions come from `app/tool.lua`.
