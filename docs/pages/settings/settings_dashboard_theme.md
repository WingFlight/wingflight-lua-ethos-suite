...
source: app/pages/settings_dashboard_theme.lua
---
...
[Page implementation](../../../src/wfsuite/app/pages/settings_dashboard_theme.lua). Menu conditions come from `app/tool.lua`.
