...
source: app/pages/settings_dashboard_settings.lua
---
...
[Page implementation](../../../src/wfsuite/app/pages/settings_dashboard_settings.lua). Menu conditions come from `app/tool.lua`.
