...
-- "refuse to register, log why" contract this suite's other background-task
...
local function dashboardPackageReady()
  ...
  return dashboardApi.init({hostId = "wingflight", baseDir = "wfsuite", apiVersion = DASHBOARD_API_VERSION})
end
