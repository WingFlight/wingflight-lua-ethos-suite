...
local common = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/widgets/dashboard/themes/danielrc/common.lua"))()
...
return {
    ...
    scheduler = {spread_scheduling = true, spread_scheduling_paint = false, spread_ratio = 0.6}
}
