...
-- (rotorflight, or the standalone `dashboard` widget) if that suite happened
...
if package.loaded["wfsuite.dashboard.context"] then
  return package.loaded["wfsuite.dashboard.context"]
end
