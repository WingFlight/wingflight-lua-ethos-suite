...
if package.loaded["wfsuite.lib.msp_esc_parameters_blheli_s"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_blheli_s"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_blheli_s"] = msp
return msp
