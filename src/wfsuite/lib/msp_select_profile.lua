...
if package.loaded["wfsuite.lib.msp_select_profile"] then
  return package.loaded["wfsuite.lib.msp_select_profile"]
end
...
package.loaded["wfsuite.lib.msp_select_profile"] = msp_select_profile
