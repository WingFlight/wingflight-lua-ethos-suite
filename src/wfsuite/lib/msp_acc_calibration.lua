...
if package.loaded["wfsuite.lib.msp_acc_calibration"] then
  return package.loaded["wfsuite.lib.msp_acc_calibration"]
end
...
package.loaded["wfsuite.lib.msp_acc_calibration"] = msp_acc_calibration
