...
-- printing" section).
if package.loaded["wfsuite.lib.msp_feature_config"] then
  return package.loaded["wfsuite.lib.msp_feature_config"]
end
...
package.loaded["wfsuite.lib.msp_feature_config"] = msp_feature_config
