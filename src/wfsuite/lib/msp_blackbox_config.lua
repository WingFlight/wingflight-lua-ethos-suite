...
if package.loaded["wfsuite.lib.msp_blackbox_config"] then
  return package.loaded["wfsuite.lib.msp_blackbox_config"]
end
...
package.loaded["wfsuite.lib.msp_blackbox_config"] = msp_blackbox_config
