...
if package.loaded["wfsuite.lib.msp_4wif_esc_fwd_prog"] then
  return package.loaded["wfsuite.lib.msp_4wif_esc_fwd_prog"]
end
...
package.loaded["wfsuite.lib.msp_4wif_esc_fwd_prog"] = msp_4wif_esc_fwd_prog
