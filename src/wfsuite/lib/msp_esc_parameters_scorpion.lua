...
if package.loaded["wfsuite.lib.msp_esc_parameters_scorpion"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_scorpion"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_scorpion"] = msp
return msp
