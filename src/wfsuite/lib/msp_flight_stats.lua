...
if package.loaded["wfsuite.lib.msp_flight_stats"] then
  return package.loaded["wfsuite.lib.msp_flight_stats"]
end
...
package.loaded["wfsuite.lib.msp_flight_stats"] = msp_flight_stats
