...
if package.loaded["wfsuite.lib.msp_dataflash_summary"] then
  return package.loaded["wfsuite.lib.msp_dataflash_summary"]
end
...
package.loaded["wfsuite.lib.msp_dataflash_summary"] = msp_dataflash_summary
