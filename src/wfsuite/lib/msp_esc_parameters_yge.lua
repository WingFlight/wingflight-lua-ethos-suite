...
if package.loaded["wfsuite.lib.msp_esc_parameters_yge"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_yge"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_yge"] = msp
return msp
