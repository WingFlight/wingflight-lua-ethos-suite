...
if package.loaded["wfsuite.lib.msp_beeper_config"] then
  return package.loaded["wfsuite.lib.msp_beeper_config"]
end
...
package.loaded["wfsuite.lib.msp_beeper_config"] = msp_beeper_config
