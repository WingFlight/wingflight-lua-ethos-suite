...
if package.loaded["wfsuite.lib.msp_battery_config"] then
  return package.loaded["wfsuite.lib.msp_battery_config"]
end
...
package.loaded["wfsuite.lib.msp_battery_config"] = msp_battery_config
