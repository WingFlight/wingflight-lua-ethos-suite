...
if package.loaded["wfsuite.lib.msp_sdcard_summary"] then
  return package.loaded["wfsuite.lib.msp_sdcard_summary"]
end
...
package.loaded["wfsuite.lib.msp_sdcard_summary"] = msp_sdcard_summary
