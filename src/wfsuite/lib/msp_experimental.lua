...
if package.loaded["wfsuite.lib.msp_experimental"] then
  return package.loaded["wfsuite.lib.msp_experimental"]
end
...
package.loaded["wfsuite.lib.msp_experimental"] = msp_experimental
