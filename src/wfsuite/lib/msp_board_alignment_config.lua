...
if package.loaded["wfsuite.lib.msp_board_alignment_config"] then
  return package.loaded["wfsuite.lib.msp_board_alignment_config"]
end
...
package.loaded["wfsuite.lib.msp_board_alignment_config"] = msp_board_alignment_config
