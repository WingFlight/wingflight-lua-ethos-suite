...
if package.loaded["wfsuite.lib.msp_smartfuel_config"] then
  return package.loaded["wfsuite.lib.msp_smartfuel_config"]
end
...
package.loaded["wfsuite.lib.msp_smartfuel_config"] = msp_smartfuel_config
