...
if package.loaded["wfsuite.lib.msp_esc_sensor_config"] then
  return package.loaded["wfsuite.lib.msp_esc_sensor_config"]
end
...
package.loaded["wfsuite.lib.msp_esc_sensor_config"] = msp_esc_sensor_config
