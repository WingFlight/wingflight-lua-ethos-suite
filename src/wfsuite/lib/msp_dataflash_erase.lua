...
if package.loaded["wfsuite.lib.msp_dataflash_erase"] then
  return package.loaded["wfsuite.lib.msp_dataflash_erase"]
end
...
package.loaded["wfsuite.lib.msp_dataflash_erase"] = msp_dataflash_erase
