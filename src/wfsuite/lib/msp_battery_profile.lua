...
if package.loaded["wfsuite.lib.msp_battery_profile"] then
  return package.loaded["wfsuite.lib.msp_battery_profile"]
end
...
package.loaded["wfsuite.lib.msp_battery_profile"] = msp_battery_profile
