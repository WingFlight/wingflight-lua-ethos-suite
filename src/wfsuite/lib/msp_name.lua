...
-- configuration.lua. A standard (non-Wingflight-specific) MSP command,
...
-- printing" section).
if package.loaded["wfsuite.lib.msp_name"] then
  return package.loaded["wfsuite.lib.msp_name"]
end
...
package.loaded["wfsuite.lib.msp_name"] = msp_name
return msp_name
