...
if package.loaded["wfsuite.lib.msp_telemetry_config"] then
  return package.loaded["wfsuite.lib.msp_telemetry_config"]
end
...
package.loaded["wfsuite.lib.msp_telemetry_config"] = msp_telemetry_config
