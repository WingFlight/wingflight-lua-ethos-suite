...
if package.loaded["wfsuite.lib.msp_esc_parameters_xdfly"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_xdfly"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_xdfly"] = msp
return msp
