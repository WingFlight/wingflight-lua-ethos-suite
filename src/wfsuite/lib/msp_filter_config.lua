...
-- printing" section).
if package.loaded["wfsuite.lib.msp_filter_config"] then
  return package.loaded["wfsuite.lib.msp_filter_config"]
end
...
package.loaded["wfsuite.lib.msp_filter_config"] = msp_filter_config
