...
if package.loaded["wfsuite.lib.msp_esc_parameters_bluejay"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_bluejay"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_bluejay"] = msp
return msp
