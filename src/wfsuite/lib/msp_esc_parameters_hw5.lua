...
if package.loaded["wfsuite.lib.msp_esc_parameters_hw5"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_hw5"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_hw5"] = msp
return msp
