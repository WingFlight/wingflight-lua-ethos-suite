...
return function(decoders)
  ...
  return {
    ...
    [0x10C0] = {name = "Motor1Speed", unit = UNIT_RPM, prec = 0, min = 0, max = 65535, dec = decU16},
    [0x10C1] = {name = "Motor2Speed", unit = UNIT_RPM, prec = 0, min = 0, max = 65535, dec = decU16},
    ...
    [0x1206] = {name = "Osc Limiter", unit = UNIT_RAW, prec = 0, min = 0, max = 65535, dec = decU16},
