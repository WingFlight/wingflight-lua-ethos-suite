...
if package.loaded["wfsuite.lib.msp_esc_parameters_omp"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_omp"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_omp"] = msp
return msp
