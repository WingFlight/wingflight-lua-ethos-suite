...
if package.loaded["wfsuite.lib.msp_esc_parameters_am32"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_am32"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_am32"] = msp
return msp
