...
if package.loaded["wfsuite.lib.msp_adjustments"] then
  return package.loaded["wfsuite.lib.msp_adjustments"]
end
...
package.loaded["wfsuite.lib.msp_adjustments"] = msp_adjustments
