...
if package.loaded["wfsuite.lib.msp_sensor_alignment"] then
  return package.loaded["wfsuite.lib.msp_sensor_alignment"]
end
...
package.loaded["wfsuite.lib.msp_sensor_alignment"] = msp_sensor_alignment
