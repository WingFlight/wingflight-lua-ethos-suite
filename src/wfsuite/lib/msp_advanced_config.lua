...
-- printing" section).
if package.loaded["wfsuite.lib.msp_advanced_config"] then
  return package.loaded["wfsuite.lib.msp_advanced_config"]
end
...
package.loaded["wfsuite.lib.msp_advanced_config"] = msp_advanced_config
