...
if package.loaded["wfsuite.lib.msp_esc_parameters_flyrotor"] then
  return package.loaded["wfsuite.lib.msp_esc_parameters_flyrotor"]
end
...
package.loaded["wfsuite.lib.msp_esc_parameters_flyrotor"] = msp
return msp
