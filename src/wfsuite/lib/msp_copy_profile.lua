...
if package.loaded["wfsuite.lib.msp_copy_profile"] then
  return package.loaded["wfsuite.lib.msp_copy_profile"]
end
...
package.loaded["wfsuite.lib.msp_copy_profile"] = msp_copy_profile
