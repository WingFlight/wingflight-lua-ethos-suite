...
if package.loaded["wfsuite.lib.activelook_config"] then
  return package.loaded["wfsuite.lib.activelook_config"]
end
...
package.loaded["wfsuite.lib.activelook_config"] = config
return config
