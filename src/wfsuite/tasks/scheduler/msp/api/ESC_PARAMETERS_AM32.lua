...
local function resolveTimeout(state, isWrite)
    ...
    local protocolRef = wfsuite.tasks and wfsuite.tasks.msp and wfsuite.tasks.msp.protocol
...
local function parseRead(buf)
    ...
    if encoding == "unknown" and raw ~= nil and wfsuite.utils and wfsuite.utils.log then
        wfsuite.utils.log("AM32 timing_advance raw value out of range: " .. tostring(raw), "info")
    end
