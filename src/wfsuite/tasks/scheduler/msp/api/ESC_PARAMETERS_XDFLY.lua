...
local API_NAME = "ESC_PARAMETERS_XDFLY"
...
local motorDirection = {"@i18n(api.ESC_PARAMETERS_XDFLY.tbl_cw)@", "@i18n(api.ESC_PARAMETERS_XDFLY.tbl_ccw)@"}
local accel = {"@i18n(api.ESC_PARAMETERS_XDFLY.tbl_fast)@", "@i18n(api.ESC_PARAMETERS_XDFLY.tbl_normal)@", "@i18n(api.ESC_PARAMETERS_XDFLY.tbl_slow)@", "@i18n(api.ESC_PARAMETERS_XDFLY.tbl_vslow)@"}
local autoRestart = {"@i18n(api.ESC_PARAMETERS_XDFLY.tbl_off)@", "90s"}
...
local brakeType = {"@i18n(api.ESC_PARAMETERS_XDFLY.tbl_normal)@", "@i18n(api.ESC_PARAMETERS_XDFLY.tbl_reverse)@"}
