...
local API_NAME = "MIXER_INPUT_YAW"
...
-- is MIXER_IN_STABILIZED_YAW = 3 (see pg/mixer.h). MSP_SET_MIXER_INPUT (171)
...
local SIM_RESPONSE = core.simResponse({
    ...
    232, 3,   24, 252,   232, 3,     -- MIXER_IN_STABILIZED_YAW:   rate=1000, min=-1000, max=1000
})
