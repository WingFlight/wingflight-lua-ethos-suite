...
local defaultApiPath = "SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/api/"
local defaultApiHelpPath = "SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/apihelp/"
local defaultCorePath = "SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/api/core.lua"
...
function api.loadPage(apiName, loadOpts)
    ...
    if module and module.setOwner then
        local owner = wfsuite.tasks.lastScript
        if owner then
