...
local MSP_PROTOCOL_VERSION = wfsuite.config.mspProtocolVersion or 1
...
local protocol = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/protocols.lua"))()
local helpers = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/helpers.lua"))()
...
msp.bus = wfsuite.bus
msp.genericActions = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/generic_actions.lua"))()
...
msp.mspHelper = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/mspHelper.lua"))()
local apiLoader = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/api.lua"))()
msp.api       = apiLoader
msp.apiEngine = "v2"
msp.common    = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/common.lua"))()
...
function msp.getApiCore()
    if not msp.apicore then
        msp.apicore = assert(loadfile("SCRIPTS:/" .. wfsuite.config.baseDir .. "/tasks/scheduler/msp/api/core.lua"))()
    end
    return msp.apicore
end
...
function msp.wakeup()
    ...
    -- enable logging
    -- wfsuite.tasks.msp.enableProtoLog(true)
