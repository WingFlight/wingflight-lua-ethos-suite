    ...
    if createSensorList[appId] ~= nil then
        ...
        if frsky_legacy.createSensorCache[appId] == nil then
            ...
            if frsky_legacy.createSensorCache[appId] == nil then
                ...
                frsky_legacy.createSensorCache[appId]:module(wfsuite.session.telemetrySensor:module())
...
function frsky_legacy.wakeup()
    ...
    if wfsuite.tasks and wfsuite.tasks.telemetry and wfsuite.session.telemetryState and wfsuite.session.telemetrySensor then
