...
-- LOGS:/wfsuite/boot_timing.log, not just print()'d -- print() output is
...
local function bgLogResults()
  if os and os.mkdir then
    pcall(os.mkdir, "LOGS:")
    pcall(os.mkdir, "LOGS:/wfsuite")
  end
  local bootLogFile = io.open("LOGS:/wfsuite/boot_timing.log", "a")
