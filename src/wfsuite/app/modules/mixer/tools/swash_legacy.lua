...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {t = "@i18n(app.modules.mixer.collective_tilt_correction_pos)@",    api = "MIXER_CONFIG:collective_tilt_correction_pos", apiversiongte = {22, 0, 0}},
            {t = "@i18n(app.modules.mixer.collective_tilt_correction_neg)@",    api = "MIXER_CONFIG:collective_tilt_correction_neg", apiversiongte = {22, 0, 0}},
