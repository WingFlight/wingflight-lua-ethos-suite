...
function common.saveConfig(config)
    ...
    wfsuite.preferences.activelook = wfsuite.preferences.activelook or {}
    local prefs = wfsuite.preferences.activelook
    local changed = false
    ...
    if changed then
        ...
        wfsuite.session.activelookReset = true
    end
...
function common.setPreviewMode(modeKey)
    ...
    if modeKey == "preflight" or modeKey == "inflight" or modeKey == "postflight" then
        wfsuite.session.activelookPreviewMode = modeKey
    else
        wfsuite.session.activelookPreviewMode = nil
    end
end
