...
local function openPage(opts)
    ...
    wfsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.shortcuts)@")
    ...
    local saved = wfsuite.preferences.shortcuts or {}
    ...
    wfsuite.app.formFields[formFieldCount] = form.addBooleanField(modeLine, nil,
    ...
    if #registry.groups == 0 then
        wfsuite.app.formLines[#wfsuite.app.formLines + 1] = form.addLine("@i18n(app.modules.settings.shortcuts_none)@")
    else
        local groupChoices = {}
        ...
        wfsuite.app.formFields[formFieldCount] = form.addChoiceField(groupLine, nil, groupChoices,
        ...
        if group then
            ...
            for _, item in ipairs(group.items) do
                ...
                wfsuite.app.formFields[formFieldCount] = form.addBooleanField(line, nil,
...
local function onSaveMenu()
    ...
    local function doSave()
        ...
        wfsuite.ini.save_ini_file("SCRIPTS:/" .. wfsuite.config.preferences .. "/preferences.ini", prefs)
