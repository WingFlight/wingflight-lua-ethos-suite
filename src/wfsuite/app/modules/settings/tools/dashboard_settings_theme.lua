...
local function openPage(opts)
    ...
    wfsuite.session.dashboardEditingTheme = source .. "/" .. folder
    ...
    form.clear()
    wfsuite.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. title)
    ...
    if page.configure then
        ...
        wfsuite.utils.reportMemoryUsage(title)
