...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            {t = "@i18n(app.modules.profile_pidcontroller.time)@", label = 2, mspapi = 1, apikey = "error_decay_time_cyclic"}, {t = "@i18n(app.modules.profile_pidcontroller.limit)@", inline = 1, label = 2, mspapi = 1, apikey = "error_decay_limit_cyclic"},
