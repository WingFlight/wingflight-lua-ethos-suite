...
local function getProfileKey()
    local escDetails = wfsuite.session and wfsuite.session.escDetails or {}
...
function helper.postLoad(pageKey)
    ...
    local convertPageValueTable = wfsuite.app and wfsuite.app.utils and wfsuite.app.utils.convertPageValueTable
