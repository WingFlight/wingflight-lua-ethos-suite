...
PageFiles[#PageFiles + 1] = {title = "@i18n(app.modules.esc_tools.mfg.flrtr.other)@", script = "esc_other.lua", image = "other.png", disablebutton = function(param) return disablebutton(#PageFiles, param) end, mspversion = {22, 0, 0}}
