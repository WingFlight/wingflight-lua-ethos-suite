    ...
    groups = {
        ...
        },
        {
            ...
            items = {
                ...
                {
                    "s_setup_menu_mixer_mixer_lua_f2d3d7f26b",
                    "@i18n(app.modules.mixer.name)@",
                    false,
                    "app/modules/mixer/mixer.lua",
        ...
        },
        {
            ...
            items = {
                ...
                {
                    "s_advanced_menu_rates_advanced_tools_a_f8cf8114e3",
                    "@i18n(app.modules.rates_advanced.name)@",
                    false,
                    "app/modules/rates_advanced/tools/advanced.lua",
        ...
        },
        {
            ...
            items = {
                ...
                { "s_esc_motors_governor_lua_5569424c21", "@i18n(app.modules.esc_motors.governor)@", false, "esc_motors/tools/governor.lua", "app/modules/esc_motors/gfx/governor.png", false },
                {
