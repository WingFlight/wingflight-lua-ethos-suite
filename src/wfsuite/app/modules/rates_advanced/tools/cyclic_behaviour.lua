...
local function getFields()
    return wfsuite.app and wfsuite.app.Page and wfsuite.app.Page.apidata and wfsuite.app.Page.apidata.formdata and wfsuite.app.Page.apidata.formdata.fields
end
...
local function setFormFieldEnabled(index, enabled)
    local formField = wfsuite.app and wfsuite.app.formFields and wfsuite.app.formFields[index]
