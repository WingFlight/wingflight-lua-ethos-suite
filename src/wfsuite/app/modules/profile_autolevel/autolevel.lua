...
local apidata = {
    ...
    formdata = {
        labels = {
            ...
            { t = "@i18n(app.modules.profile_autolevel.auto_hover)@", inline_size = 13.6, label = 4 }
        },
        fields = {
            ...
            { t = "@i18n(app.modules.profile_autolevel.gain)@", inline = 2, label = 4, mspapi = 1, apikey = "autohover_gain" },
            { t = "@i18n(app.modules.profile_autolevel.max)@", inline = 1, label = 4, mspapi = 1, apikey = "autohover_max_angle" },
            { t = "@i18n(app.modules.profile_autolevel.max_rate)@", inline = 1, label = 4, mspapi = 1, apikey = "autohover_max_rate" }
        }
    }
}
