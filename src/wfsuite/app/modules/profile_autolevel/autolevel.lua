...
local apidata = {
    ...
    formdata = {
        labels = {
            ...
            { t = "@i18n(app.modules.profile_autolevel.atthold_mode)@", inline_size = 13.6, label = 4 }
        },
        fields = {
            ...
            { t = "@i18n(app.modules.profile_autolevel.gain)@", inline = 2, label = 4, mspapi = 1, apikey = "atthold_gain" },
            { t = "@i18n(app.modules.profile_autolevel.deadband)@", inline = 1, label = 4, mspapi = 1, apikey = "atthold_deadband" }
        }
    }
}
