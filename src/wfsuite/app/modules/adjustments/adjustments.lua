...
local ADJUST_FUNCTIONS = {
    ...
    {id = 30, name = "@i18n(app.modules.adjustments.fn_yaw_collective_dyn)@", min = -125, max = 125, maxApi = {12, 0, 7}, hide = true},
    {id = 31, name = "@i18n(app.modules.adjustments.fn_yaw_collective_decay)@", min = 1, max = 250, maxApi = {12, 0, 7}, hide = true},
    ...
    {id = 71, name = "@i18n(app.modules.adjustments.fn_col_setpoint_boost_gain)@", min = 0, max = 255, minApi = {12, 0, 8}, hide = true},
    ...
    {id = 76, name = "@i18n(app.modules.adjustments.fn_gov_idle_throttle)@", min = 0, max = 250, minApi = {12, 0, 9}, hide = true},
    {id = 77, name = "@i18n(app.modules.adjustments.fn_gov_auto_throttle)@", min = 0, max = 250, minApi = {12, 0, 9}, hide = true},
    {id = 78, name = "@i18n(app.modules.adjustments.fn_gov_max_throttle)@", min = 0, max = 100, minApi = {12, 0, 9}, hide = true},
    {id = 79, name = "@i18n(app.modules.adjustments.fn_gov_min_throttle)@", min = 0, max = 100, minApi = {12, 0, 9}, hide = true},
    {id = 80, name = "@i18n(app.modules.adjustments.fn_gov_headspeed)@", min = 0, max = 10000, minApi = {12, 0, 9}, hide = true},
    {id = 81, name = "@i18n(app.modules.adjustments.fn_gov_yaw_ff)@", min = 0, max = 250, minApi = {12, 0, 9}, hide = true},
