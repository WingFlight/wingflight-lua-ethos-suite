...
local ADJUST_FUNCTIONS = {
    ...
    {id = 66, name = "@i18n(app.modules.adjustments.fn_yaw_inertia_precomp_gain)@", min = 0, max = 250, minApi = {22, 0, 0}},
    {id = 67, name = "@i18n(app.modules.adjustments.fn_yaw_inertia_precomp_cutoff)@", min = 0, max = 250, minApi = {22, 0, 0}},
    ...
    {id = 75, name = "@i18n(app.modules.adjustments.fn_yaw_precomp_cutoff)@", min = 0, max = 250, minApi = {22, 0, 0}},
