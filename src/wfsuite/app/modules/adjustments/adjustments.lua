...
local ADJUST_FUNCTIONS = {
    ...
    {id = 26, name = "@i18n(app.modules.adjustments.fn_yaw_cw_stop_gain)@", min = 25, max = 250, hide = true},
    {id = 27, name = "@i18n(app.modules.adjustments.fn_yaw_ccw_stop_gain)@", min = 25, max = 250, hide = true},
    {id = 28, name = "@i18n(app.modules.adjustments.fn_yaw_cyclic_ff)@", min = 0, max = 250, hide = true},
    {id = 29, name = "@i18n(app.modules.adjustments.fn_yaw_collective_ff)@", min = 0, max = 250, hide = true},
    {id = 30, name = "@i18n(app.modules.adjustments.fn_yaw_collective_dyn)@", min = -125, max = 125, maxApi = {22, 0, 0}, hide = true},
    {id = 31, name = "@i18n(app.modules.adjustments.fn_yaw_collective_decay)@", min = 1, max = 250, maxApi = {22, 0, 0}, hide = true},
    {id = 32, name = "@i18n(app.modules.adjustments.fn_pitch_collective_ff)@", min = 0, max = 250, hide = true},
    ...
    {id = 39, name = "@i18n(app.modules.adjustments.fn_rescue_climb_collective)@", min = 0, max = 1000, hide = true},
    {id = 40, name = "@i18n(app.modules.adjustments.fn_rescue_hover_collective)@", min = 0, max = 1000, hide = true},
    {id = 41, name = "@i18n(app.modules.adjustments.fn_rescue_hover_altitude)@", min = 0, max = 2500, hide = true},
    {id = 42, name = "@i18n(app.modules.adjustments.fn_rescue_alt_p)@", min = 0, max = 250, hide = true},
    {id = 43, name = "@i18n(app.modules.adjustments.fn_rescue_alt_i)@", min = 0, max = 250, hide = true},
    {id = 44, name = "@i18n(app.modules.adjustments.fn_rescue_alt_d)@", min = 0, max = 250, hide = true},
    ...
    {id = 48, name = "@i18n(app.modules.adjustments.fn_governor_gain)@", min = 0, max = 250, hide = true},
    {id = 49, name = "@i18n(app.modules.adjustments.fn_governor_p)@", min = 0, max = 250, hide = true},
    {id = 50, name = "@i18n(app.modules.adjustments.fn_governor_i)@", min = 0, max = 250, hide = true},
    {id = 51, name = "@i18n(app.modules.adjustments.fn_governor_d)@", min = 0, max = 250, hide = true},
    {id = 52, name = "@i18n(app.modules.adjustments.fn_governor_f)@", min = 0, max = 250, hide = true},
    {id = 53, name = "@i18n(app.modules.adjustments.fn_governor_tta)@", min = 0, max = 250, hide = true},
    {id = 54, name = "@i18n(app.modules.adjustments.fn_governor_cyclic_ff)@", min = 0, max = 250, hide = true},
    {id = 55, name = "@i18n(app.modules.adjustments.fn_governor_collective_ff)@", min = 0, max = 250, hide = true},
    ...
    {id = 59, name = "@i18n(app.modules.adjustments.fn_pitch_o)@", min = 0, max = 250, hide = true},
    {id = 60, name = "@i18n(app.modules.adjustments.fn_roll_o)@", min = 0, max = 250, hide = true},
    {id = 61, name = "@i18n(app.modules.adjustments.fn_cross_coupling_gain)@", min = 0, max = 250, hide = true},
    {id = 62, name = "@i18n(app.modules.adjustments.fn_cross_coupling_ratio)@", min = 0, max = 250, hide = true},
    {id = 63, name = "@i18n(app.modules.adjustments.fn_cross_coupling_cutoff)@", min = 0, max = 250, hide = true},
    ...
    {id = 66, name = "@i18n(app.modules.adjustments.fn_yaw_inertia_precomp_gain)@", min = 0, max = 250, minApi = {22, 0, 0}, hide = true},
    {id = 67, name = "@i18n(app.modules.adjustments.fn_yaw_inertia_precomp_cutoff)@", min = 0, max = 250, minApi = {22, 0, 0}, hide = true},
    {id = 68, name = "@i18n(app.modules.adjustments.fn_pitch_setpoint_boost_gain)@", min = 0, max = 255, minApi = {22, 0, 0}},
    {id = 69, name = "@i18n(app.modules.adjustments.fn_roll_setpoint_boost_gain)@", min = 0, max = 255, minApi = {22, 0, 0}},
    {id = 70, name = "@i18n(app.modules.adjustments.fn_yaw_setpoint_boost_gain)@", min = 0, max = 255, minApi = {22, 0, 0}},
    {id = 71, name = "@i18n(app.modules.adjustments.fn_col_setpoint_boost_gain)@", min = 0, max = 255, minApi = {22, 0, 0}, hide = true},
    {id = 72, name = "@i18n(app.modules.adjustments.fn_yaw_dyn_ceiling_gain)@", min = 0, max = 250, minApi = {22, 0, 0}},
    {id = 73, name = "@i18n(app.modules.adjustments.fn_yaw_dyn_deadband_gain)@", min = 0, max = 250, minApi = {22, 0, 0}},
    {id = 74, name = "@i18n(app.modules.adjustments.fn_yaw_dyn_deadband_filter)@", min = 0, max = 250, minApi = {22, 0, 0}},
    {id = 75, name = "@i18n(app.modules.adjustments.fn_yaw_precomp_cutoff)@", min = 0, max = 250, minApi = {22, 0, 0}, hide = true},
    {id = 76, name = "@i18n(app.modules.adjustments.fn_gov_idle_throttle)@", min = 0, max = 250, minApi = {22, 0, 0}, hide = true},
    {id = 77, name = "@i18n(app.modules.adjustments.fn_gov_auto_throttle)@", min = 0, max = 250, minApi = {22, 0, 0}, hide = true},
    {id = 78, name = "@i18n(app.modules.adjustments.fn_gov_max_throttle)@", min = 0, max = 100, minApi = {22, 0, 0}, hide = true},
    {id = 79, name = "@i18n(app.modules.adjustments.fn_gov_min_throttle)@", min = 0, max = 100, minApi = {22, 0, 0}, hide = true},
...
local function auxIndexToMember(auxIndex)
    ...
    local rx = wfsuite.session and wfsuite.session.rx
...
local function functionVisible(def)
    if def.hide then return false end
    if def.minApi and not wfsuite.utils.apiVersionCompare(">=", def.minApi) then return false end
    if def.maxApi and not wfsuite.utils.apiVersionCompare("<=", def.maxApi) then return false end
    return true
end
...
local function updateSaveButtonState()
    local nav = wfsuite.app and wfsuite.app.formNavigationFields
...
local function readAdjustmentRangeSlot(slotIndex, onComplete, onError)
    ...
    local API = wfsuite.tasks.msp.api.loadPage("GET_ADJUSTMENT_RANGE")
    if not API then
...
local function readAdjustmentFunctions(onComplete, onError)
    ...
    local API = wfsuite.tasks.msp.api.loadPage("GET_ADJUSTMENT_FUNCTION_IDS")
    if not API then
...
local function shouldUseMspFunctionNamePrefetch()
    return wfsuite.utils.apiVersionCompare(">=", MSP_FUNCTION_NAME_PREFETCH_MIN_API)
end
...
local function readAdjustmentRangesBulk(onComplete, onError)
    local API = wfsuite.tasks.msp.api.loadPage("ADJUSTMENT_RANGES")
    if not API then
...
local function readAdjustmentRanges()
    local function finalizeWithRanges(rawRanges, messageOverride)
        ...
        local callback = wfsuite.tasks and wfsuite.tasks.callback
...
local function startLoad()
    ...
    state.pendingSlotLoads = {}
    state.needsRender = true
    wfsuite.app.ui.progressDisplay(MODULE_TITLE, "@i18n(app.modules.adjustments.loading_ranges)@")
...
local function queueSetAdjustmentRange(slotIndex, done, failed)
    ...
    local API = wfsuite.tasks.msp.api.loadPage("SET_ADJUSTMENT_RANGE")
    if not API then
...
local function queueEepromWrite(done, failed)
    local API = wfsuite.tasks.msp.api.loadPage("EEPROM_WRITE")
    if not API then
    ...
    if not ok and failed then
        if reason == "armed_blocked" then
            failed(wfsuite.utils.getArmedSaveBlockedMessage())
        else
...
local function saveAllRanges()
    ...
    state.saving = true
    state.infoMessage = nil
    wfsuite.app.ui.progressDisplay(MODULE_TITLE, "@i18n(app.modules.adjustments.saving_changed_ranges)@")
...
local function openPage(opts)
    ...
    wfsuite.app.lastScript = opts.script
    wfsuite.session.lastPage = opts.script
