...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            ...
            { t = "@i18n(app.modules.filters.rpm_preset)@", label = 11, inline = 1, mspapi = 1, apikey = "rpm_preset", type = 1, apiversiongte = {22, 0, 0} },
            { t = "@i18n(app.modules.filters.rpm_min_hz)@", label = 12, inline = 1, mspapi = 1, apikey = "rpm_min_hz", apiversiongte = {22, 0, 0} }
        }
    }
}
