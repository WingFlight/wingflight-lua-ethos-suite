...
if package.loaded["wfsuite.app.progress_dialog"] then
  return package.loaded["wfsuite.app.progress_dialog"]
end
...
package.loaded["wfsuite.app.progress_dialog"] = progress_dialog
