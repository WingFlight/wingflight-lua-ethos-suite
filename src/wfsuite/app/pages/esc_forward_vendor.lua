...
if package.loaded["wfsuite.app.pages.esc_forward_vendor"] then
  return package.loaded["wfsuite.app.pages.esc_forward_vendor"]
end
...
package.loaded["wfsuite.app.pages.esc_forward_vendor"] = esc_forward_vendor
