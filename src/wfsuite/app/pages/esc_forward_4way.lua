...
if package.loaded["wfsuite.app.pages.esc_forward_4way"] then
  return package.loaded["wfsuite.app.pages.esc_forward_4way"]
end
...
package.loaded["wfsuite.app.pages.esc_forward_4way"] = esc_forward_4way
