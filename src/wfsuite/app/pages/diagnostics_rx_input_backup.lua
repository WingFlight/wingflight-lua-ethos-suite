...
-- firmware (rx_input_backup_provider) - NONE/SBUS/FBUS/FPORT/FPORT2/IBUS/
-- SUMD/SPEK1024/SPEK2048 - the Protocol line below is already generic.
--
    ...
    local function applyStatus(data)
      if not data.enabled then
        ...
        if activeField and activeField.color then
          activeField:color(isBackup and RED or GREEN)
        end
      end
