...
local function buildFields(runtime, fieldLayout)
  ...
  fieldLayout.buildSingle(runtime, "@i18n(app.modules.autolevel.max)@", {key = "trainer_angle_limit"})
...
local function open(opts)
  autolevel.open(opts, "@i18n(app.modules.autolevel.acro_trainer)@", "trainer", buildFields)
end
