...
if package.loaded["wfsuite.app.pages.beepers_page"] then
  return package.loaded["wfsuite.app.pages.beepers_page"]
end
...
package.loaded["wfsuite.app.pages.beepers_page"] = beepers_page
return beepers_page
