...
local function open(opts)
  ...
  addBool(statePanel, "@i18n(app.modules.settings.gps_fix_state)@", "gps_fix")
  ...
  addBool(statusPanel, "@i18n(app.modules.settings.status_rx_backup)@", "status_rx_backup")
  ...
  addBool(statusPanel, "@i18n(app.modules.settings.status_autotrim)@", "status_autotrim")
