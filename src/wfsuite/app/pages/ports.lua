...
local PORT_FUNCTIONS = {
  ...
  {id = 4194304, excl = 4194304, name = "@i18n(app.modules.ports.function_rx_input_backup)@", type = PORT_TYPE_AUTO},
...
local function open(opts)
  ...
  local function dispose()
    ...
    portsWorking = {}
    fields = {}
    package.loaded["wfsuite.lib.msp_serial_config"] = nil
    package.loaded["wfsuite.lib.msp_rx_config"] = nil
