...
local function open(opts)
  ...
  line = form.addLine("@i18n(app.modules.settings.addressed_writes)@")
  form.addBooleanField(line, nil,
    function()
      return settings and settings.developer and settings.developer.addressed_writes == true
    end,
    function(value)
      if not settings then return end
      settings.developer = settings.developer or {}
      settings.developer.addressed_writes = value == true
      updateSaveEnabled()
    end)
