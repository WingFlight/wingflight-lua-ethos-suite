...
if package.loaded["wfsuite.app.pages.blackbox_edit_page"] then
  return package.loaded["wfsuite.app.pages.blackbox_edit_page"]
end
...
package.loaded["wfsuite.app.pages.blackbox_edit_page"] = blackbox_edit_page
