...
-- (app/modules/diagnostics/tools/elrs_telemetry.lua), by way of that
-- suite's own rfsuite-full-rewrite branch. Unlike the other
...
--
-- All state (probe/sync progress, the Wingflight and ELRS-module
...
local T = {
  ...
  wingflight = "@i18n(app.modules.elrs_telemetry.wingflight)@",
  ...
  fcToElrs = "@i18n(app.modules.elrs_telemetry.action_wf_to_elrs)@",
  elrsToFc = "@i18n(app.modules.elrs_telemetry.action_elrs_to_wf)@",
...
local function open(opts)
  ...
  local function formatFcSummary()
  ...
  -- earlier visit this connection, kick off the Wingflight telemetry-
  ...
  line = form.addLine(T.wingflight)
  fields.wingflight = form.addStaticText(line, nil, formatFcSummary())
