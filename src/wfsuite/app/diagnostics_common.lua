...
if package.loaded["wfsuite.app.diagnostics_common"] then
  return package.loaded["wfsuite.app.diagnostics_common"]
end
...
package.loaded["wfsuite.app.diagnostics_common"] = diagnostics_common
