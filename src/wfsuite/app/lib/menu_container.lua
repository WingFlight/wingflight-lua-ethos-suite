...
function container.create(cfg)
    ...
    local function openPage(opts)
        ...
        for i, item in ipairs(pages) do
            local hideEntry = (item.ethosversion and not wfsuite.utils.ethosVersionAtLeast(item.ethosversion)) or
                (item.mspversion and wfsuite.utils.apiVersionCompare("<", item.mspversion)) or
