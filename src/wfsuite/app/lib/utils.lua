...
local simevent = wfsuite.simevent
...
function utils.getInlinePositions(f)
    ...
    local lPage = wfsuite.app.Page.apidata.formdata
...
function utils.settingsSaved(savedPage)
    ...
    local actions = wfsuite.tasks and wfsuite.tasks.msp and wfsuite.tasks.msp.genericActions
