...
-- depends on per-radio template constants (wfsuite.app.radio.*) this
...
if package.loaded["wfsuite.app.header"] then
  return package.loaded["wfsuite.app.header"]
end
...
package.loaded["wfsuite.app.header"] = header
return header
